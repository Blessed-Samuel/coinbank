        ...
        <>
            <div className='bg-mainColorPrimary rounded-xl grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-20 pt-16 items-center'>
                <div className='space-y-8 md:mx-0 mx-auto md:pl-16 md:pb-10 md:items-start items-center flex flex-col'>
                    <h1 className='text-white md:max-w-sm text-5xl leading-[130%] md:text-left text-center'>Sign in <span className='text-gray-200'>to get $50 worth of crypto</span></h1>
                    <Button noBackground className={`py-2 text-nowrap bg-mainWhite text-mainColorPrimary`}>Get Started</Button>
                </div>
